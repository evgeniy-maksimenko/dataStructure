...
//                {new DoublyLinkedList()}
    ...
    public AlistTest(EList<Integer> listObj) {
        aList = listObj;
    ...
    public void testAddStart1() {
        ...
        assertArrayEquals(new Integer[]{100}, aList.toArray());
    }
    ...
    public void testAddStart2() {
        ...
        assertArrayEquals(new Integer[]{200,100}, aList.toArray());
    }
    ...
    public void testAddStart3() {
        ...
        assertArrayEquals(new Integer[]{300,200,100}, aList.toArray());
    }
    ...
    public void testAddStart4() {
        ...
        assertArrayEquals(new Integer[]{400,300,200,100}, aList.toArray());
    }
    ...
    public void testAddEnd2() {
        ...
        aList.addEnd(200);
        assertEquals(2, aList.size());
        assertArrayEquals(new Integer[]{100,200}, aList.toArray());
    }
    ...
    public void testAddEnd3() {
        ...
        aList.addEnd(300);
        assertEquals(3, aList.size());
        assertArrayEquals(new Integer[]{100,200,300}, aList.toArray());
    }
    ...
    public void testAddEnd4() {
        ...
        aList.addEnd(400);
        assertEquals(4, aList.size());
        assertArrayEquals(new Integer[]{100,200,300,400}, aList.toArray());
    }

    @Test
    public void testAddPos1() {
        aList.clear();
        aList.init(new Integer[]{1,2,3,4,5});
        assertEquals(5, aList.size());
        aList.addPos(0,100);
        assertEquals(6, aList.size());
        //assertArrayEquals(new Integer[]{100,1,2,3,4,5}, aList.toArray());
    }
    ...
    public void testAddPos2() {
        ...
        aList.addPos(1,100);
        assertEquals(6, aList.size());
        assertArrayEquals(new Integer[]{1,100,2,3,4,5}, aList.toArray());
    }
    ...
    public void testAddPos3() {
        ...
        aList.addPos(3,100);
        assertEquals(6, aList.size());
        assertArrayEquals(new Integer[]{1,2,3,100,4,5}, aList.toArray());
    }
    ...
    public void testAddPos4() {
        ...
        aList.addPos(4,100);
        assertEquals(6, aList.size());
        assertArrayEquals(new Integer[]{1,2,3,4,100,5}, aList.toArray());
    }

    @Test
    public void testDelStart1() {
        aList.init(new Integer[]{120});
        assertEquals(1, aList.size());
    ...
    public void testDelStart2() {
        aList.init(new Integer[]{240,120});
        assertEquals(2, aList.size());
        int Actual = aList.delStart();
        assertEquals(1, aList.size());
        assertEquals(240, Actual);
        assertArrayEquals(new Integer[]{120}, aList.toArray());
    }

    @Test
    public void testDelStart3() {
        aList.init(new Integer[]{700,240,120});
        assertEquals(3, aList.size());
        int Actual = aList.delStart();
        assertEquals(2, aList.size());
        assertEquals(700, Actual);
        assertArrayEquals(new Integer[]{240, 120}, aList.toArray());
    }
    ...
    public void testDelEnd1() {
        ...
        assertEquals(2, aList.size());
        assertEquals(120, Actual);
        assertArrayEquals(new Integer[]{700,240}, aList.toArray());
    }

    @Test
    public void testDelEnd2() {
        aList.init(new Integer[]{700,240});
        assertEquals(2, aList.size());
        int Actual = aList.delEnd();
        assertEquals(1, aList.size());
        assertEquals(240, Actual);
        assertArrayEquals(new Integer[]{700}, aList.toArray());
    }

    @Test
    public void testDelEnd3() {
        aList.init(new Integer[]{700});
        assertEquals(1, aList.size());
        int Actual = aList.delEnd();
        assertEquals(0, aList.size());
        assertEquals(700, Actual);
    ...
    public void testDelPos1() {
        aList.init(new Integer[]{700,100});
        assertEquals(2, aList.size());
    ...
    public void testDelPos2() {
        aList.init(new Integer[]{700,100,800});
        assertEquals(3, aList.size());
        int Actual = aList.delPos(2);
        assertEquals(2, aList.size());
        assertEquals(800, Actual);
        assertArrayEquals(new Integer[]{700,100}, aList.toArray());
    }
    ...
    public void testDelPos3() {
        ...
        assertEquals(2, aList.size());
        assertEquals(700, Actual);
        assertArrayEquals(new Integer[]{100,800}, aList.toArray());
    }
    ...
    public void testSize2() {
        aList.init(new Integer[]{1});
        assertEquals(1, aList.size());
    }

    @Test
    public void testSize3() {
        aList.init(new Integer[]{1,2});
        assertEquals(2, aList.size());
    }

    @Test
    public void testSize4() {
        aList.init(new Integer[]{1,2,3});
        assertEquals(3, aList.size());
    }

    @Test
    public void testSize5() {
        aList.init(new Integer[]{1,2,3,4,5,6,7});
    ...
    public void testMin1() {
        aList.init(new Integer[]{120, 340, 292, 33, 24});
        assertEquals(24, aList.min());
    }

    @Test
    public void testMin2() {
        aList.init(new Integer[]{33, 24});
        assertEquals(24, aList.min());
    }

    @Test
    public void testMin3() {
        aList.init(new Integer[]{24});
        assertEquals(24, aList.min());
    }
    ...
    public void testSort3() {
        aList.init(new Integer[]{34,1});
        assertEquals(2, aList.size());
        aList.sort();
        assertArrayEquals(new Integer[]{1,34}, aList.toArray());
    }

    @Test
    public void testSort4() {
        aList.init(new Integer[]{34,1,23});
        assertEquals(3, aList.size());
        aList.sort();
        assertArrayEquals(new Integer[]{1,23,34}, aList.toArray());
    }
    ...
    public void testReverse4() {
        ...
        assertEquals(3, aList.size());
        aList.reverse();
        assertArrayEquals(new Integer[]{23,1,34}, aList.toArray());
    }
    ...
    public void testGet2() {
        aList.init(new Integer[]{10});
        assertEquals(1, aList.size());
        assertEquals((Integer)10, aList.get(0));
    }
    ...
    public void testGet3() {
        aList.init(new Integer[]{34,1});
        assertEquals(2, aList.size());
        assertEquals((Integer)1, aList.get(1));
    }
    ...
    public void testGet4() {
        aList.init(new Integer[]{34,1,23});
        assertEquals(3, aList.size());
        assertEquals((Integer)23, aList.get(2));
    }
    ...
    public void testSet1() {
        aList.init(new Integer[]{120, 340, 292, 33, 24});
        Integer[] expected = {120, 200, 292, 33, 24};
        aList.set(1, 200);
    ...
    public void testSet2() {
        aList.init(new Integer[]{120, 340});
        Integer[] expected = {120, 200};
        aList.set(1, 200);
        assertArrayEquals(expected, aList.toArray());
    }
